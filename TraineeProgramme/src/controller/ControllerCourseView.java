...
public class ControllerCourseView implements Initializable {
    ...
    public void backToTrainee(ActionEvent actionEvent) throws IOException {
        try {
         ...
         //   backFromCourseViewToTraineeView.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("../view/index.jpg"))));

/*          FileInputStream input = new FileInputStream("/src/view/back.png");
            Image image = new Image(input);
            ImageView imageView = new ImageView(image);
            Button button = new Button("Back", imageView);
            backFromCourseViewToTraineeView = button;*/
